...
2. Spawn it with `harness: "pi"`, `model: "cliproxy/gpt-5.6-luna"`, `reasoning_effort: "xhigh"`, and the current trusted project as `working_dir`. Do not duplicate its implementation in the parent session.
