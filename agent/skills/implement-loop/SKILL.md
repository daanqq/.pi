...
`model: "openai-codex/gpt-5.6-luna"`, and `reasoning_effort: "xhigh"`.
...
3. Invoke `code-review` against the fixed point and spec. Spawn its fresh, parallel Standards and Spec reviewers with `subagent_spawn` using `harness: "pi"`, `model: "openai-codex/gpt-5.6-luna"`, and `reasoning_effort: "xhigh"`; wait for both.
