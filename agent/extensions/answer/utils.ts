...
export function mergeAnswerSettings(
	...
	return {
		...
		enableCommand: projectSettings?.enableCommand ?? globalSettings?.enableCommand,
		drafts: {
			enabled:
		...
		singleQuestion: {
			quickByDefault:
				projectSettings?.singleQuestion?.quickByDefault ??
				globalSettings?.singleQuestion?.quickByDefault ??
				DEFAULT_SINGLE_QUESTION_SETTINGS.quickByDefault,
			skipFinalConfirmation:
				projectSettings?.singleQuestion?.skipFinalConfirmation ??
				globalSettings?.singleQuestion?.skipFinalConfirmation ??
				DEFAULT_SINGLE_QUESTION_SETTINGS.skipFinalConfirmation,
		},
		grillMe: {
			enabled:
				projectSettings?.grillMe?.enabled ??
				globalSettings?.grillMe?.enabled ??
				DEFAULT_GRILL_ME_SETTINGS.enabled,
			preferForSingleQuestion:
				projectSettings?.grillMe?.preferForSingleQuestion ??
				globalSettings?.grillMe?.preferForSingleQuestion ??
				DEFAULT_GRILL_ME_SETTINGS.preferForSingleQuestion,
			forceQuickMode:
				projectSettings?.grillMe?.forceQuickMode ??
				globalSettings?.grillMe?.forceQuickMode ??
				DEFAULT_GRILL_ME_SETTINGS.forceQuickMode,
		},
	};
}
