...
| `delete-current-session.ts` | Adds `/delete` and `Delete`: asks for confirmation, starts a fresh session, then removes the previous current session file from history. | `/delete`, `Delete` |
