...
- `agent/codex-usage-state.json`, `agent/codex-rotation-state.json`, `agent/codex-usage.lock/`, `agent/codex-rotation.lock/`, `agent/codex-usage-profiles/` — local Codex usage/rotation runtime state, locks, and plaintext profile credentials.
